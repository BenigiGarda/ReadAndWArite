    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <form action="/adminhomeonlogin" method="GET">
            ...
            ?>
            <td>
            <a href="/adminhomeonlogin/type?id={{$gambar->type}}" class="btn_type"> <img src="/images/{{$gambar->photo}}" height="200" width="200" alt=""> </a>
           </td>
           <?php    
            }
            ?>
